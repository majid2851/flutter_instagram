...
import 'package:flutter_instagram/state/image_upload/extensions/get_image_data_aspect_ratio.dart';
...
import 'package:flutter_instagram/state/posts/models/post_payload.dart';
...
class ImageUploadNotifier extends StateNotifier<IsLoading>
{
  ...
  Future<bool> upload({
    ...
    final thumbnailAspectRatio = await
      thumbnailUint8List.getAspectRatio();
    ...
    try{
      final thumbnailUploadTask=await
        thumbnailRef.putData(thumbnailUint8List);
