...
import 'package:flutter_instagram/views/components/file_thumbnail_view.dart';
import 'package:flutter_instagram/views/constatns/strings.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';
import 'package:flutter_hooks/flutter_hooks.dart';

import '../../state/post_settings/model/post_setting.dart';
...
class _CreateNewPostViewState extends
  ConsumerState<CreateNewPostView>
{
  @override
  Widget build(BuildContext context)
  {
    ...
    useEffect((){
      ...
      [postController]//key to use useEffect
    );
        ...
        actions: [
          IconButton(
              ...
              () async{
                ...
                final isUploaded = await ref.read(imageUploadProvider.notifier)
                  .upload(
                    file: widget.fileToPost,
                    fileType: widget.fileType,
                    message: message,
            ...
            ...PostSetting.values.map(
              (postSetting)=>ListTile(
                ...
                trailing: Switch(
                  ...
                  onChanged: (isOn){
                    ref.read(postSettingProvider.notifier)
